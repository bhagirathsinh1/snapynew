...
class CameraFromEventDetails extends StatefulWidget {
  const CameraFromEventDetails({
    Key? key,
  ...
  @override
  CameraFromEventDetailsState createState() => CameraFromEventDetailsState();
}

class CameraFromEventDetailsState extends State<CameraFromEventDetails>
